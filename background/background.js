...
function createMenus() {
    ...
    browser.contextMenus.create({
        id: "verifyPartialText",
        title: "verifyPartialText",
        documentUrlPatterns: ["<all_urls>"],
        contexts: ["all"]
    });
    browser.contextMenus.create({
    ...
    browser.contextMenus.create({
        id: "findInTableAndClick",
        title: "findInTableAndClick",
        documentUrlPatterns: ["<all_urls>"],
        contexts: ["all"]
    });
    browser.contextMenus.create({
        id: "storeTextFindInTable",
        title: "storeTextFindInTable",
        documentUrlPatterns: ["<all_urls>"],
        contexts: ["all"]
    });
    browser.contextMenus.create({
        id: "verifyTitleAcceptOverride",
        title: "verifyTitleAcceptOverride",
        documentUrlPatterns: ["<all_urls>"],
        contexts: ["all"]
    });
}
