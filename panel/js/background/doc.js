...
"A locator for the form to be submitted","A locator","A locator","The expected string of the title (Exact matching). The next command will still be run even if the text verification fails. Variable declared in the storeXXX commands can be used in the string. For example: \"Hello ${var_usr}\"","A locator","A locator","A locator", "verify eccept override. The expected string of the title (Exact matching). The next command will still be run even if the text verification fails. Variable declared in the storeXXX commands can be used in the string. For example: \"Hello ${var_usr}\""];
