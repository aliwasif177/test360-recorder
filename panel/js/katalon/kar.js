...
function ajaxPost(testCaseSelected, testName, content) {
    ...
    var url = "http://ec2-18-216-198-217.us-east-2.compute.amazonaws.com:8081/export";
...
function createSite() {
    ...
    var url = "http://ec2-18-216-198-217.us-east-2.compute.amazonaws.com:8081/site";
...
function createGroupTest() {
    ...
    var url = "http://ec2-18-216-198-217.us-east-2.compute.amazonaws.com:8081/groupTestCase";
...
const url = 'http://ec2-18-216-198-217.us-east-2.compute.amazonaws.com:8081/sites';
var jsson=null;
// Populate dropdown with list of provinces
$.getJSON(url, function (data) {

$.each(data, function (key, entry) {
    siteDropdown.append($('<option></option>').attr('value', entry.siteId).text(entry.siteName));
    })
});
}
...
$('#select-site').change(function() {
    ...
    $("#select-test-case").empty().append(function() {              
        const urlTestCase = 'http://ec2-18-216-198-217.us-east-2.compute.amazonaws.com:8081/site/'+siteId;       
        $.getJSON(urlTestCase, function (date) {
            $.each(date, function (key, entry) {
                testCaseDropDown.append($('<option></option>').attr('value', entry.testCaseId).text(entry.name));
            })               
        });
    });
});
